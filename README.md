...
Sprint 5C's current-data, PostGIS-backed detection against persisted road
LineStrings is documented in [docs/route-flood-impact.md](docs/route-flood-impact.md).
